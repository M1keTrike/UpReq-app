...
- [ ] T116 Ejecutar las validaciones manuales V1 a V5 y V7 a V9 del [quickstart.md](quickstart.md) en un dispositivo Android físico — **ya no bloqueado por falta de hardware ni por el bug de T110** (ambos arreglados esta sesión), pero todavía no ejecutado
